...
struct OptionThreeEditView: View {
    // MBTI
        ...
        ZStack {
            ...
            VStack {
                ...
                Button{
                    ...
                    let newData: [String: Any] = ["MBTI": preferenceThree]
...
struct OptionThreeEditView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        OptionThreeEditView(isPreferenceThree: $isPreferenceThree, preferenceThree: $preferenceThree, email: $email)
    }
}
